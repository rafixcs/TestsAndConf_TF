...
void blowfish_enc(BLOWFISH_CTX *ctx, unsigned int *xl, unsigned int *xr);

void blowfish_dec(BLOWFISH_CTX *ctx, unsigned int *xl, unsigned int *xr);

void blowfish_init(BLOWFISH_CTX *ctx, unsigned int *key, int keyLen);
